...
The following chart is an animation detailing the Open PSC Tasks from month-to-month over the 2019-20 FY.

![](resources/img/PSC_open.gif){width=650px}

Whilst this animation details both Open and Completed PSC Tasks from month-to-month over the 2019-20 FY.

![](resources/img/PSC_combined.gif){width=650px}
